...
namespace BookStore.Application.Services.Identity
{
    public class UserProfileService : IUserProfileService
    {
        ...
        public UserProfileService(IUserProfileRepository userProfiles, IDbSession session, IStorageService storages)
        {
        ...
        public async Task<BaseResult<UserProfileDto>> GetMyProfileAsync(Guid userId)
        {
            ...
            if (profile == null)
                return BaseResult<UserProfileDto>.NotFound("User profile not found.");
            ...
            Guid userId, UpdateUserProfileDto dto)
        {
            ...
            if (profile == null)
            {
                ...
                await _userProfiles.AddAsync(profile);
            }
